...
static inline quaternion_t quaternion_rotation(double theta, vector_t axis) {
...
// Add two quaternions.
static inline quaternion_t quaternion_add(quaternion_t q, quaternion_t r) {
  return quaternion(q.a + r.a, q.b + r.b, q.c + r.c, q.d + r.d);
}

// Get product of two quaternions.
static inline quaternion_t quaternion_product(quaternion_t q, quaternion_t r) {
  return quaternion(q.a * r.a - q.b * r.b - q.c * r.c - q.d * r.d,
...
static inline quaternion_t quaternion_scale(quaternion_t q, double scale) {
  return quaternion(q.a * scale, q.b * scale, q.c * scale, q.d * scale);
}

// Use quaternion to rotate a vector.
static inline vector_t rotate_vector(quaternion_t q, vector_t v) {
